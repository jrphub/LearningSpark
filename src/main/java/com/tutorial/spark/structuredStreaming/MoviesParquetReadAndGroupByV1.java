 ...
 */
public class MoviesParquetReadAndGroupByV1 {
	...
	public static void main(String[] args) {
		...
		SparkConf conf = new SparkConf()
			 ...
			 */
			.setAppName("MoviesParquetReadAndGroupByV1");
		...
		//Problem
		//We can't make this global for all dataset shuffling as some dataset can be large and needs more shuffle partitions
	}
